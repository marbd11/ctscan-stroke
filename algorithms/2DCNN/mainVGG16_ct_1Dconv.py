...
class Args:
    def __init__(self):
        ...
        self.outputPath = './VGG16Outputs_1DConv/' + now + '/'
...
if __name__=='__main__':
    ...
    for train, test in kfold.split(model_images):
        ...
        model = Sequential()
        model.add(Conv2D(input_shape=( args.width, args.height, args.num_slices), filters=64, kernel_size=(3, 3), padding="same", activation="relu"))
