...
class Args:
    def __init__(self):
        ...
        self.outputPath = './cnnLstmModels/' + now + '/'
...
if __name__=='__main__':
    ...
    #base_model = efn.EfficientNetB5(include_top = False, weights = "imagenet", input_shape = (args.width, args.height, args.channels))
    #cnnOut = base_model.layers[118].output

    base_model = tf.keras.applications.EfficientNetB0(include_top = False, weights = "imagenet", input_shape = (args.width, args.height, args.channels))

    #print(base_model.summary())

    cnnModel = tf.keras.Model(base_model.input, base_model.output)

    #cnnModel = tf.keras.Model(base_model)
    ...
    model.fit_generator(generator=training_generator,
                        ...
                        epochs=args.epochs, shuffle=True, workers=4,  use_multiprocessing=False,
