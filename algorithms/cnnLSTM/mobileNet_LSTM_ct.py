...
class Args:
    def __init__(self):
        ...
        self.outputPath = './mobileNet_Lstm_outputs/' + now + '/'
...
if __name__ == '__main__':
    ...
    for train, test in kfold.split(model_images):
        ...
        cnn.add(DepthwiseConv2D((3,3), padding="same", depth_multiplier=1, strides=(1,1)))
        cnn.add(BatchNormalization(axis=2))
        cnn.add(Activation("relu"))
        ...
        cnn.add(DepthwiseConv2D((3,3), padding="same", depth_multiplier=1, strides=(2,2)))
        cnn.add(BatchNormalization(axis=2))
        cnn.add(Activation("relu"))
        cnn.add(Conv2D(128, (3, 3), padding="same", strides=(1,1)))
        cnn.add(BatchNormalization(axis=2))
        cnn.add(Activation("relu"))
        ...
        cnn.add(BatchNormalization(axis=2))
        cnn.add(Activation("relu"))
        cnn.add(Conv2D(512, (3, 3), padding="same", strides=(1,1)))
        cnn.add(BatchNormalization(axis=2))
        cnn.add(Activation("relu"))
        ...
        cnn.add(BatchNormalization(axis=2))
        cnn.add(Activation("relu"))
        cnn.add(Conv2D(1024, (3, 3), padding="same", strides=(1,1)))
        cnn.add(BatchNormalization(axis=2))
        cnn.add(Activation("relu"))
